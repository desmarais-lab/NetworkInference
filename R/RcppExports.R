...
netinf_ <- function(node_ids, node_names, cascade_ids, cascade_times, model = 0L, alpha = 1.0, n_iter = 5L) {
    .Call('NetworkInference_netinf_', PACKAGE = 'NetworkInference', node_ids, node_names, cascade_ids, cascade_times, model, alpha, n_iter)
}
